function DisplayResultsLS4p(p,residuals,timevect,NoB,dsc)
...
try
    ...
    if (existings_index ~= 0) %existing result struct
        %Adding new results:
        testresults{existings_index,1}.LS.SINAD = SINAD;
        testresults{existings_index,1}.LS.ENOB = ENOB;
        ...
        %Adding new results:
        testresults{res_len + 1,1}.LS.SINAD = SINAD;
        testresults{res_len + 1,1}.LS.ENOB = ENOB;
    end
    ...
    %Adding new results:
    testresults{1,1}.LS.SINAD = SINAD;
    testresults{1,1}.LS.ENOB = ENOB;
    assignin ('base','adctest_process_results',testresults);
end
