function adctest
% @fn adctest
% @brief Main function of the ADC Test 4.3. Implements the Main Window of
...
hPushButtonClassifyAndProcess = uicontrol('Style','pushbutton',...
                                'String','Classify and process measurement record',...
                                'Units','normalized',...
                                'Position',[0.1 0.12 0.6 0.1],...
                                'Callback',@ClassifyAndProcess_callback);
%%%%%%%OBSOLETE PUSHBUTTONS                                
...
UpdateDisplay;
    ...
    function ClassifyAndProcess_callback(source,eventdata)
        info_line_string = get(hTextInfo,'String');
        set(hTextInfo,'String','Processing descriptor...');
        set(hTextInfo,'BackgroundColor','Green');                
    ...
    function UpdateDisplay
        if ~(isempty(descriptors))
            ...
            set(hPushButtonClassifyAndProcess,'Enable','on');
        else
            ...
            set(hPushButtonClassifyAndProcess,'Enable','off');
        end
    end
